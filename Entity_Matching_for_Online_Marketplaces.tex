...
\hypersetup{unicode=true,
            pdftitle={Entity Matching for Online Marketplace: Applying Text Embeddings and Deep Learning to Product Matching},
            pdfauthor={Kyle Gilde},
...
\def\footnote{\protect\rmarkdownfootnote}
  ...
  \title{Entity Matching for Online Marketplace: Applying Text Embeddings and
Deep Learning to Product Matching}
    \author{Kyle Gilde\textsuperscript{1}}
    \date{}
  
\shorttitle{Entity Matching for Online Marketplace}
\affiliation{
\vspace{0.5cm}
\textsuperscript{1} Master of Science in Data Science
...
Gilde, Chicago, IL. E-mail:
\href{mailto:kylegilde@gmail.com}{\nolinkurl{kylegilde@gmail.com}}}
