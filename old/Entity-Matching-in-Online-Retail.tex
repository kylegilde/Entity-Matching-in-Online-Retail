...
\hypersetup{unicode=true,
            pdftitle={Entity Matching for Online Marketplaces},
...
\def\footnote{\protect\rmarkdownfootnote}
  ...
  \title{Entity Matching for Online Marketplaces}
    \author{Kyle Gilde\textsuperscript{1}}
    \date{}
  
\shorttitle{Entity Matching for Online Marketplaces}
\affiliation{
\vspace{0.5cm}
\textsuperscript{1} City University of New York - School of Professional Studies - Data Science}
...
We used R (Version 3.2.1; R Core Team, 2015) and the R-package
